<%-- 
    Document   : dangernoodle
    Created on : 03-Oct-2018, 14:31:03
    Author     : ARJUN
--%>
...
<head>
	...
	body{
		...
		background: linear-gradient(#a2b9bc, white, #a2b9bc);
	}
	h1{
		color: black;
	}
...
<div class="Game_Name">
	<h1> PLAY SNAKE! </h1>
        <form name="snakeform" onsubmit="return false;">
...
function draw() {
	...
	ctx.fillText("MAXIMUM SCORE: " + max_score, canvas.width-150, canvas.height-10);
}
...
function restart(){
    ...
    document.forms["snakeform"].action="SnakeServlet";
    document.forms["snakeform"].method="POST";
    document.forms["snakeform"].onsubmit="return true;";
    document.forms["snakeform"].submit();
