<%-- 
    Document   : tictactoe
    Created on : 04-Oct-2018, 11:15:31
    Author     : ARJUN
--%>
...
<html>
    <head>
        ...
        <script language="JavaScript">        
            ...
            function submitgame(){
                document.game.action="ScoreUpdation";document.game.method="post"; document.game.onsubmit= "return true"; document.game.submit();
            }
</script>
<style>
    body{
        ...
        <center>
            <div>
                <h1>TIC TAC TOE</h1>
                    <h1>WHAT TO DO?</h1>
		<ul type="none">
			<li>Press Start to play this game.</li>
			<li>Drag your cursor in the dashes</li>
			<li>
				Game Rules:
				<ul type="none">
					<li>If the ball hits the paddle you'll get one point</li>
					<li>If the ball hits the ground its <b>GAME OVER</b></li>
					<li>Try to get the <i>maximum score!</i></li>
				</ul>
			</li>
		</ul>
            </div>
            ...
            <br>
            <br>
            <input type="button" value="Submit Score" onclick="submitgame();">
            </form>
        </center>
    </body>
</html>
